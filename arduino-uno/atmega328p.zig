...
// commit: 89c4b267220e9f977d10bfcebc1947f30d0a0f56
//
// vendor: Atmel
// device: ATmega328
// cpu: AVR8
...
pub const registers = struct {
    ...
    pub const ADC = struct {
        ...
        pub const ADC = @intToPtr(*volatile MmioInt(16, u10), 0x78);
    ...
    pub const PORTC = struct {
        ...
        pub const PORTC = @intToPtr(*volatile MmioInt(8, u7), 0x28);

        /// address: 0x27
        /// Port C Data Direction Register
        pub const DDRC = @intToPtr(*volatile MmioInt(8, u7), 0x27);

        /// address: 0x26
        /// Port C Input Pins
        pub const PINC = @intToPtr(*volatile MmioInt(8, u7), 0x26);
    };
    ...
    pub const EEPROM = struct {
        ...
        pub const EEAR = @intToPtr(*volatile MmioInt(16, u10), 0x41);
